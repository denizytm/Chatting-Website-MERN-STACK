...
export function FriendRequestsContainerE ({ currentUser , contacts , friendRequests , setFriendRequests , socket }) {
                            ...
                            return (
                                <div key={index} className="request">
                                    <img 
                                        ...
                                        style={contact.isImageDefault ? {} : {borderRadius : "100%" , width : "4rem" , height :"4rem" } }   
                                    />
